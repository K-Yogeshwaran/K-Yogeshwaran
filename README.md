...
* 🔭 **Active Development**: Currently working on an **Air Quality Prediction Project** where I apply feature engineering and outlier handling to improve model accuracy.
* 🌱 **Continuous Learning**: Mastering **Deep Learning** and **Artificial Intelligence** frameworks to solve real-world problems.
...
* 🧩 **Interests**: Passionate about **Competitive Programming** and mastering complex **Data Structures & Algorithms**.
